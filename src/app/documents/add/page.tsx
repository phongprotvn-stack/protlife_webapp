    ...
    <div className="h-full flex flex-col">
      <div className="flex items-center gap-2 mb-5">
        ...
        <div>
          ...
          <p className="text-[11px] text-[#8E8E93]">Tải lên tài liệu mới</p>
        </div>
      </div>
      <div className="flex-1 flex items-center justify-center">
        <div className="text-center">
          <div className="w-16 h-16 rounded-full bg-[rgba(255,149,0,0.08)] mx-auto mb-3 flex items-center justify-center">
