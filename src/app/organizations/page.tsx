...
import { Plus, Search, Building2, RefreshCw, ChevronLeft, ChevronRight, ArrowUpDown } from 'lucide-react';
    ...
    return (
      <div className="page-content">
        <div className="flex items-center justify-between mb-4">
          <div><h1 className="text-[22px] font-bold text-[#111] tracking-tight">Tổ chức</h1><p className="text-[12px] text-[#8E8E93] mt-0.5">0 tổ chức</p></div>
        </div>
