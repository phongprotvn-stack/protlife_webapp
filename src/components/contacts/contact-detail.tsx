            ...
            <div className="space-y-2">
              ...
              <div className="flex items-center justify-between p-2.5 rounded-[10px] bg-[rgba(0,0,0,0.02)]">
                <div className="flex items-center gap-2.5">
                  <Award size={14} style={{color:getRelationshipColor(contact.RelationshipScore)}}/>
                  <span className="text-[12px] text-[#5F6368]">Điểm kết nối</span>
                </div>
