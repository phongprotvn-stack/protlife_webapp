...
interface Props { organizationId: string | null; onClose: () => void; panelMode?: boolean; }

export function OrganizationDetail({ organizationId, onClose, panelMode }: Props) {
    ...
    <div>
      ...
      {confirmDelete && (
        <div className="mb-4 p-4 rounded-[14px] bg-[rgba(230,0,45,0.06)] border border-[rgba(230,0,45,0.12)] text-center">
          ...
          <p className="text-[14px] font-semibold text-[#E6002D] mb-1">Xoá tổ chức này?</p>
      ...
      <div className="text-center py-8">
        <div className="w-16 h-16 rounded-full bg-[rgba(88,86,214,0.08)] mx-auto mb-3 flex items-center justify-center"><Building2 size={28} className="text-[#5856D6]/40"/></div>
        <p className="text-[14px] font-medium text-[#6B7280]">Tổ chức chưa có dữ liệu</p>
  ...
  return <Modal open={!!organizationId} onClose={onClose} title="" maxWidth="420px">{content}</Modal>;
}
